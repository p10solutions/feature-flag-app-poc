...
/// <summary>
/// Endpoints de demonstracao para o modo com AWS AppConfig Agent.
/// Use esta controller quando a API estiver configurada com <c>ConnectionMode=Agent</c>.
/// </summary>
[ApiController]
[Route("agent")]
...
{
    /// <summary>
    /// Retorna o documento bruto carregado pelo AppConfig Agent.
    /// </summary>
    /// <remarks>
    /// Este endpoint ajuda a validar se o sidecar do AppConfig Agent esta respondendo
    /// e se a API conseguiu materializar o snapshot em memoria.
    /// </remarks>
    ...
    {
        var modeCheck = EnsureMode(AppConfigConnectionMode.Agent);
    ...
    /// <summary>
    /// Simula o acesso a home da aplicacao no modo Agent.
    /// </summary>
    /// <remarks>
    /// Se a flag <c>maintenance-mode</c> estiver ligada, a API retorna <c>503</c>.
    /// </remarks>
    ...
    private ObjectResult? EnsureMode(AppConfigConnectionMode expectedMode)
    {
        ...
        {
            Message = $"Esta controller representa o modo {expectedMode}, mas a API esta configurada para {options.Value.ConnectionMode}.",
            ExpectedMode = expectedMode.ToString(),
